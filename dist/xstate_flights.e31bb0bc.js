  ...
  states: {
    editing: {
      on: {
        ...
        "UPDATE.OUTBOUND": {
          actions: (0, _xstate.assign)({
            tripDate: function tripDate(_, event) {
              return event.value;
            }
          })
        },
        "UPDATE.INBOUND": {
          actions: (0, _xstate.assign)({
            returnDate: function returnDate(_, event) {
              return event.value;
            }
          })
        },
        SUBMIT: {
          cond: function cond(ctx) {
            if (ctx.trip === "One Way") {
              ...
              return !!ctx.returnDate && !!ctx.tripDate && ctx.returnDate > ctx.tripDate;
            }
          },
          target: "submitted"
        }
...
service.onTransition(function (state) {
  console.log("ctx on transition", state.context); // disable or enable return field based on select
  ...
  var canSubmit = machine.transition(state, "SUBMIT").changed;
...
tripDate.addEventListener("change", function (e) {
  service.send({
    type: "UPDATE.OUTBOUND",
    value: e.target.value
  });
});
returnField.addEventListener("change", function (e) {
  service.send({
    type: "UPDATE.INBOUND",
    value: e.target.value
  });
...
//# sourceMappingURL=/xstate_flights.e31bb0bc.js.map